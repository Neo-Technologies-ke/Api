        ...
        playlists: [
          {
            ...
            childrenApi: "https://api.lifereformationcentre.org/content/sermons/public/tvFeed/" + churchId
          },
          {
            id: "lessons",
            name: "Lessons",
          ...
          },
          {
            ...
            apiUrl: "https://api.lifereformationcentre.org/content/sermons/public/freeshowSample"
          }
          //
        ]
      };
        ...
        sermons.forEach((sermon: Sermon) => {
          if (sermon.playlistId === playlistNode.id) {
            const sermonNode: any = {
              ...
              apiUrl: "https://api.lifereformationcentre.org/content/sermons/public/tvFeed/" + churchId + "/" + sermon.id
            };
