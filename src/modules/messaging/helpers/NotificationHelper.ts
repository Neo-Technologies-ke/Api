...
export class NotificationHelper {
  ...
  static sendEmailNotification = async (email: string, notifications: Notification[], privateMessages: PrivateMessage[], senderEmail?: string) => {
    ...
    try {
      await EmailHelper.sendTemplatedEmail("noreply@lifereformationcentre.org", email, "Life Reformation Centre", "https://admin.lifereformationcentre.org", title, content, "ChurchEmailTemplate.html", replyTo);
